...
ALTER PROCEDURE [dbo].[SGC_SP_ExpedienteCredito_I]                                                                       
--Datos de Persona                                            
  ...
  BEGIN TRANSACTION                   
    ...
    Begin                                            
		...
		begin              
			...
			IF (@Celular1Repetido = '' and @Celular2Repetido = '' and @TelefonoRepetido = '') 
			begin  
		...
		begin 
			...
			+ IIF(@Celular1Repetido != '', @Celular1Repetido ,  
				IIF(@Celular2Repetido != '',  @Celular2Repetido,  
					IIF(@TelefonoRepetido != '', @TelefonoRepetido, '') 
				) 
			) + ' está registrado en otra persona';  
		end 
	END 
