    ...
    BEGIN TRY      
        BEGIN TRANSACTION        
            ...
            IF(@MotivoCambio = 'Problemas con marcación')    
                BEGIN    
                    INSERT INTO SGF_PedidoCambio (PedidoCambioId,TipoCambioId,MotivoCambio,DescripCambio,ExpedienteCreditoId,StatusClienteId,FechaCambio,IdSupervisor,UserIdCrea,FechaCrea,EstadoPedido,ZonaId,LocalId,ProveedorNuevoId,RegionZonaId,UserIdAtendio,FechaAtendio)       
                    VALUES (@PedidoCambioId,@TipoCambioId,@MotivoCambio,@Descripcion,0,0,CONVERT(DATETIME, @Fecha, 102),@SupervisorId,@UserIdCrea,dbo.getDate(),@EstadoTicketId,@ZonaId,@LocalId,@ProveedorId,@RegionZonaId,@UserIdCrea,dbo.getDate())      
            ...
            ELSE    
                BEGIN    
                    INSERT INTO SGF_PedidoCambio (PedidoCambioId,TipoCambioId,MotivoCambio,DescripCambio,ExpedienteCreditoId,StatusClienteId,FechaCambio,IdSupervisor,UserIdCrea,FechaCrea,EstadoPedido,ZonaId,LocalId,ProveedorNuevoId,RegionZonaId)       
                    VALUES (@PedidoCambioId,@TipoCambioId,@MotivoCambio,@Descripcion,0,0,CONVERT(DATETIME, @Fecha, 102),@SupervisorId,@UserIdCrea,dbo.getDate(),@EstadoTicketId,@ZonaId,@LocalId,@ProveedorId,@RegionZonaId)      
