...
' Cambios  :                          
  ...
  11/04/2023 - Reynaldo Cauche - Se cambio el orden de las validaciones                
  18/04/2023 - Reynaldo Cauche - Se removio las variables @AgenciaAsignada, CodAnalista, NombreAnalista ya que no se usan           
  develop-CargaMAsiva - 24/10/2023 - CRISTIAN SILVA - se valido banco alfin         
  develop-CargaMasiva - 06/11/2023 -cristian silva - se agrego @ExpedienteIdOutPut para eliminar expediente de alfin      
'--------------------------------------------------------------------------------------*/                        
CREATE PROCEDURE SGC_SP_ResultLoading_U        
(@BancoId int,                            
...
BEGIN                         
    ...
    DECLARE @IdReconfirmacion int = (select top 1 IdReconfirmacion from SGF_ExpedienteCredito_Reconfirmacion where ExpedienteCreditoId = @ExpedienteCreditoId order by IdReconfirmacion desc)                         
 ...
 SET @ExpedienteIdOutPut = 0        
    ...
    BEGIN                         
     ...
     VALUES (@ExpedienteCreditoId, @ItemId, 10, NULL, NULL, dbo.getdate(), NULL, 27, NULL, NULL, 3588      
     , 'Cliente pasa a DESISTIÓ según correo de MiBanco - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,1)                      
            END                
        ...
        IF @Estado = 'DESEMBOLSO'                        
            BEGIN                         
                ...
                ELSE                         
                    INSERT INTO SGF_ExpedienteCreditoDetalle       
     VALUES (@ExpedienteCreditoId, @ItemId, 8, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
     , 'Activación confirmada por MiBanco según correo del ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                        
            END                
        ...
        SET EstadoPersonaId = 9,                       
                ...
                ELSE                    
                    INSERT INTO SGF_ExpedienteCreditoDetalle      
     VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
     , @ObservacionrEstRecha + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                     
        ...
        IF (@Estado = 'EVALUACION' or @Estado = 'PRE-PRESTAMO' or @Estado = 'REVISION') and @EstadoProcesoId = 5                       
         ...
         UPDATE SGF_ExpedienteCreditoDetalle                   
                ...
                ELSE                   
                    INSERT INTO SGF_ExpedienteCreditoDetalle      
     VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
     , @ObservacionCondicionadaMBEval + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                       
            END                
                             
        IF (@Estado = '' and @FiltroLead = 'RECHAZADO')                
            BEGIN                
                DECLARE @ObservacionCondicionadaFlRechaz varchar(500)                
                SET @ObservacionCondicionadaFlRechaz = 'RECHAZADO POR CRM según correo de MiBanco - Fecha '                 
                
                UPDATE SGF_ExpedienteCredito                   
                SET EstadoProcesoId = 9,                   
                EstadoExpedienteId = 2,                  
                FechaRechazado = dbo.getdate(),                
                Observacion = @ObservacionCondicionadaFlRechaz + @FechaCorreo,                       
                UserIdActua = 3588,                      
                FechaActua = dbo.GETDATE()                  
                WHERE ExpedienteCreditoId = @ExpedienteCreditoId                
                ...
                select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId                   
                from SGF_ExpedienteCreditoDetalle                   
                where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@ObservacionCondicionadaFlRechaz+'%'                   
                order by ExpedienteCreditoId DESC                
                
                IF (@ExpedienteUltimaObservacion != 0)                   
                    BEGIN                   
                        UPDATE SGF_ExpedienteCreditoDetalle                   
                        SET Observacion = @ObservacionCondicionadaFlRechaz + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1                   
     where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion                   
                    END                   
                ELSE                    
                    INSERT INTO SGF_ExpedienteCreditoDetalle       
     VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
     , @ObservacionCondicionadaFlRechaz + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                     
                ...
                IF (UPPER(@ResultadoGestion) like '%NO CALIFICA%')                
                    BEGIN                
                        ...
                        ELSE                    
                            INSERT INTO SGF_ExpedienteCreditoDetalle      
       VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
       , @ObservacionCondicionadaRsNoc + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL,NULL, NULL, NULL, NULL, 1)                     
...
IF (@ExpedienteUltimaObservacion != 0)                   
    ...
    ELSE                    
                            INSERT INTO SGF_ExpedienteCreditoDetalle       
       VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
       , @ResultadoGestion + ' - ' + @MotivoRechazo + ' - según correo de MiBanco Fecha' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                       
                    END                
   ...
   ELSE                    
                            INSERT INTO SGF_ExpedienteCreditoDetalle       
       VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
       , 'NO CONTACTADO según correo de MiBanco - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                       
                    END                
            END                
    ...
    BEGIN                         
       ...
       UPDATE SGF_ExpedienteCredito                         
            ...
            ELSE                      
                INSERT INTO SGF_ExpedienteCreditoDetalle      
    VALUES (@ExpedienteCreditoId, @ItemId, 8, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
    , 'Activado según correo de SURGIR - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                         
        END                         
        ...
        BEGIN                                     
            ...
            IF (@ExpedienteUltimaObservacion != 0)                     
                BEGIN                     
                    UPDATE SGF_ExpedienteCreditoDetalle                     
                    SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de SURGIR - Fecha ' + @FechaCorreo,      
         Contador = @ContadorExpUltimaObservacion + 1                     
                    where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion                     
                END                     
            ELSE                      
                INSERT INTO SGF_ExpedienteCreditoDetalle       
    VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
    , @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de SURGIR - Fecha ' + @FechaCorreo,       
  ...
  SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de SURGIR - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1, TipoRechazoId = 27            
                ...
                END                     
            ELSE                      
                INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, 10, NULL, NULL, dbo.getdate(), NULL, 27, NULL, NULL, 3588, @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió
...
según correo de SURGIR - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                       
        END                      
        ...
        BEGIN                                 
            ...
            ELSE                      
                INSERT INTO SGF_ExpedienteCreditoDetalle       
    VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588      
    , @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' -Evaluacion según correo de SURGIR - Fecha ' + @FechaCorreo,      
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                                         
        END                         
    ...
    BEGIN                         
        ...
        IF UPPER(@Estado) = 'ACTIVADO'              
            BEGIN              
                IF  @EstadoProcesoId = 5 OR @EstadoProcesoId = 9 OR @EstadoProcesoId = 10 OR @EstadoProcesoId = 16              
                    BEGIN             
                        ...
                        SET EstadoProcesoId = 8,                        
                            EstadoExpedienteId = 2,                 
                            Observacion = 'Activado según correo de ALFIN - Fecha ' + @FechaCorreo,           
                            FechaActua = dbo.GETDATE(),                         
                            UserIdActua = 3588,                     
                            FechaActivado = @Fecha       
                        WHERE ExpedienteCreditoId = @ExpedienteCreditoId              
                        ...
                        select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId                     
                        from SGF_ExpedienteCreditoDetalle                     
                        where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%Activado según correo de ALFIN - Fecha%'                     
                        order by ExpedienteCreditoId DESC              
              
                        IF (@ExpedienteUltimaObservacion != 0)                     
                            BEGIN                     
                                UPDATE SGF_ExpedienteCreditoDetalle                     
                             SET Observacion = 'Activado según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1                     
                                where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion                     
                            END                     
                        ELSE                      
                            INSERT INTO SGF_ExpedienteCreditoDetalle          
         VALUES (@ExpedienteCreditoId, @ItemId, 8, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588,           
         'Activado según correo de ALFIN - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL,NULL, NULL , NULL, NULL, NULL, NULL, 1)                         
      END    
        
      SET @ExpedienteIdOutPut = 0       
            END              
          
      IF UPPER(@Estado) = 'RECHAZADO' and @EstadoProcesoId = 5              
      BEGIN            
          UPDATE SGF_Persona                       
          SET EstadoPersonaId = 9,                       
              UserIdActua = 3588,                       
          ...
          SET EstadoProcesoId = 9,                     
              EstadoExpedienteId = 2,                      
              Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo,                         
              FechaActua = dbo.GETDATE(),                         
              UserIdActua = 3588,                     
              FechaRechazado = dbo.GETDATE()                     
          WHERE ExpedienteCreditoId = @ExpedienteCreditoId              
          ...
          select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId                     
             from SGF_ExpedienteCreditoDetalle                     
          where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' +' Rechazado según correo de ALFIN - Fecha%'                     
             order by ExpedienteCreditoId DESC                     
                                
          IF (@ExpedienteUltimaObservacion != 0)                     
          BEGIN                     
             UPDATE SGF_ExpedienteCreditoDetalle                     
                SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1                     
             where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion                     
          END                     
          ELSE        
          BEGIN        
             INSERT INTO SGF_ExpedienteCreditoDetalle           
             VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588,          
             @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo,           
             NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)         
          END        
        
          SET @ExpedienteIdOutPut = @ExpedienteCreditoId        
        
      END              
           
      IF UPPER(@Estado) = 'DESISTIO' and @EstadoProcesoId = 5              
      BEGIN              
           UPDATE SGF_Persona                        
           SET EstadoPersonaId = 10,                         
               UserIdActua = 3588,                         
           ...
           SET EstadoProcesoId = 10,                         
               EstadoExpedienteId = 2,                      
               Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Desistió según correo de ALFIN - Fecha ' + @FechaCorreo,                        
  FechaActua = dbo.GETDATE(),                         
               UserIdActua = 3588,                     
               FechaDesistio = dbo.GETDATE()                     
           WHERE ExpedienteCreditoId = @ExpedienteCreditoId                     
           ...
           select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId                     
              from SGF_ExpedienteCreditoDetalle                     
           where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Desistió según correo de ALFIN - Fecha%'                     
              order by ExpedienteCreditoId DESC                     
                                 
           IF (@ExpedienteUltimaObservacion != 0)                     
           BEGIN                     
              UPDATE SGF_ExpedienteCreditoDetalle                     
                 SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Desistió según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1, TipoRechazoId = 27           
              where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion                     
           END                     
           ELSE        
     BEGIN        
              INSERT INTO SGF_ExpedienteCreditoDetalle           
              VALUES (@ExpedienteCreditoId, @ItemId, 10, NULL, NULL, dbo.getdate(), NULL, 27, NULL, NULL, 3588,           
              @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de ALFIN - Fecha ' + @FechaCorreo,           
              NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)          
     END        
     ...
     SET @ExpedienteIdOutPut = @ExpedienteCreditoId        
      ...
      IF (UPPER(@Estado) = 'EVALUACION') and @EstadoProcesoId = 5                      
      BEGIN                                 
          UPDATE SGF_ExpedienteCredito                      
                 SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Evaluación según correo de ALFIN - Fecha ' + @FechaCorreo,                         
                     FechaActua = dbo.GETDATE(),                         
                     UserIdActua = 3588                      
                 WHERE ExpedienteCreditoId = @ExpedienteCreditoId                     
                                                 
          -- Condicionar si inserta o actualiza                     
          select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId,  
                   @ContadorExpUltimaObservacion = Contador,  
                   @ItemIdUltimaObservacion = ItemId                     
          from SGF_ExpedienteCreditoDetalle                     
          where ExpedienteCreditoId = @ExpedienteCreditoId   
          and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' +  ' Evaluación según correo de  ALFIN - Fecha  %'                     
          order by ExpedienteCreditoId DESC                     
    ...
    BEGIN  
               INSERT INTO SGF_ExpedienteCreditoDetalle           
               VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL,          
               3588, @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + ' Evaluación según correo de ALFIN - Fecha ' + @FechaCorreo,  
      NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)      
    END  
    SET @ExpedienteIdOutPut = 0     
      END                         
        ----------------------------------------------------------                  
        SET @Success = 1                         
        SET @Message = 'REGISTRO ALFIN: OK'                
                  
    END                
                         
    IF @BancoId NOT IN (3, 11, 13)                         
    BEGIN                         
        SET @Success = 0                         
