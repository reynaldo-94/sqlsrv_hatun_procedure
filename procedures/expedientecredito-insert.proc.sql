...
BEGIN TRY                                  
  BEGIN TRANSACTION                                  
	...
	Begin                                
		...
		IsBancarizado,FechaAgenda,FechaActua)                                
        values 
		...
		dbo.getdate(),dbo.getdate(),1,@Obra,@IdSupervisor,@AdvId,@BancoId,@DispositivoId,1,@TipoCredito,@IsBancarizado,dbo.GETDATE(),dbo.GETDATE())                                
