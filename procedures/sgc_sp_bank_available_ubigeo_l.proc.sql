...
BEGIN
    ...
    SET @ContUbigeoSurgir = (
        ...
        FROM (
            select CodUbigeo from SGF_UBIGEO where CodDpto='15' and CodProv='01'
            UNION
            select CodUbigeo from SGF_UBIGEO where CodDpto='07' and CodProv='01'
        ) as sr
...
-- EXEC SGC_SP_Bank_Available_Ubigeo_L '090100'