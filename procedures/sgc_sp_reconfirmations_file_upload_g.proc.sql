...
' Cambios:           
  ...
  17/11/2022 - REYNALDO CAUCHE - Se agrego una validacion para verificar si la operacion esta con el banco correcto  
'--------------------------------------------------------------------------------------*/                                  
...
BEGIN                 
    ...
    FROM (             
        SELECT
            ...
            case when exc.BancoId = @BancoId
                then
                    ...
                    'Operación pertenece a otro banco'
        ...
        GROUP BY exc.EstadoExpedienteId, exr.Estado,exc.ExpedienteCreditoId,exc.EstadoProcesoId,exr.Interesado, exc.BancoId       
 ) x             
