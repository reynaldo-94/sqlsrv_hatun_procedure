...
'--------------------------------------------------------------------------------------*/          
ALTER PROCEDURE SGC_SP_ResultLoading_U
(@BancoId int,              
        ...
        IF (@Estado = '' and @FiltroLead = 'RECHAZADO')  
            BEGIN  
                ...
                IF (@ExpedienteUltimaObservacion != 0)     
                    ...
                    END     
                ELSE      
                    INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588, @ObservacionCondicionadaFlRechaz + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)       
    ...
    BEGIN
                ...
                IF @EstadoProcesoId = 5 OR @EstadoProcesoId = 9 OR @EstadoProcesoId = 10 OR @EstadoProcesoId = 16
                    BEGIN
                        ...
                        IF (@ExpedienteUltimaObservacion != 0)       
                            ...
                            END       
                        ELSE        
                            INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, 8, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588, 'Activado según correo de ALFIN - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL , NULL, NULL, NULL, NULL, 1)           
                    END
            END
        ...
        IF UPPER(@Estado) = 'RECHAZADO' and @EstadoProcesoId = 5
            BEGIN
                ...
                SET EstadoProcesoId = 9,       
                    EstadoExpedienteId = 2,        
                    Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo,           
                    FechaActua = dbo.GETDATE(),           
                    UserIdActua = 3588,       
                    FechaRechazado = dbo.GETDATE()       
                WHERE ExpedienteCreditoId = @ExpedienteCreditoId
                ...
                select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId       
                from SGF_ExpedienteCreditoDetalle       
                where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de ALFIN - Fecha%'       
                order by ExpedienteCreditoId DESC       
        
                IF (@ExpedienteUltimaObservacion != 0)       
                    BEGIN       
                        UPDATE SGF_ExpedienteCreditoDetalle       
                        SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1       
                        where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion       
                    END       
                ELSE        
                    INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, 9, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588, @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Rechazado según correo de ALFIN - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)
            END
        ...
        IF UPPER(@Estado) = 'DESISTIO' and @EstadoProcesoId = 5
            BEGIN
                ...
                SET EstadoProcesoId = 10,           
                    EstadoExpedienteId = 2,        
                    Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de ALFIN - Fecha ' + @FechaCorreo,           
                    FechaActua = dbo.GETDATE(),           
                    UserIdActua = 3588,       
                    FechaDesistio = dbo.GETDATE()       
                WHERE ExpedienteCreditoId = @ExpedienteCreditoId       
                ...
                select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId       
                from SGF_ExpedienteCreditoDetalle       
                where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de ALFIN - Fecha%'       
                order by ExpedienteCreditoId DESC       
        
                IF (@ExpedienteUltimaObservacion != 0)       
                    BEGIN       
                        UPDATE SGF_ExpedienteCreditoDetalle       
                        SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1, TipoRechazoId = 27
                        where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion       
                    END       
                ELSE        
                    INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, 10, NULL, NULL, dbo.getdate(), NULL, 27, NULL, NULL, 3588, @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Desistió según correo de ALFIN - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)
            END
    
        IF (UPPER(@Estado) = 'EVALUACION' OR UPPER(@Estado) = 'PENDIENTE' OR UPPER(@Estado) = '') and @EstadoProcesoId = 5        
            BEGIN                   
                UPDATE SGF_ExpedienteCredito        
                SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Evaluación según correo de ALFIN - Fecha ' + @FechaCorreo,           
                    FechaActua = dbo.GETDATE(),           
                    UserIdActua = 3588        
                WHERE ExpedienteCreditoId = @ExpedienteCreditoId       
                ...
                select top(1)  @ExpedienteUltimaObservacion = ExpedienteCreditoId, @ContadorExpUltimaObservacion = Contador, @ItemIdUltimaObservacion = ItemId       
                from SGF_ExpedienteCreditoDetalle       
                where ExpedienteCreditoId = @ExpedienteCreditoId and Observacion like '%'+@Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Evaluación según correo de ALFIN - Fecha%'       
                order by ExpedienteCreditoId DESC       
        
                IF (@ExpedienteUltimaObservacion != 0)       
                    BEGIN       
                        UPDATE SGF_ExpedienteCreditoDetalle       
                        SET Observacion = @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Evaluación según correo de ALFIN - Fecha ' + @FechaCorreo, Contador = @ContadorExpUltimaObservacion + 1       
                        where ExpedienteCreditoId = @ExpedienteCreditoId and ItemId = @ItemIdUltimaObservacion       
                    END       
                ELSE        
                    INSERT INTO SGF_ExpedienteCreditoDetalle VALUES (@ExpedienteCreditoId, @ItemId, @ProcesoId, NULL, NULL, dbo.getdate(), NULL, NULL, NULL, NULL, 3588, @Contactabilidad + ' - ' + @Comentario + ' - ' + @MotivoRechazo + ' - ' + @SubMotivo + ' - Evaluación según correo de ALFIN - Fecha ' + @FechaCorreo, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1)                           
            END           
