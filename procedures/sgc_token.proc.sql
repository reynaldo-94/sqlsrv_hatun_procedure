...
' cambios  :           
 ...
 - 14-06-2023 - REYNALDO CAUCHE - Para los regionales la zona se obtiene desde el local                                                                                                                             
'--------------------------------------------------------------------------------------*/              
     
ALTER proc [dbo].[SGC_TOKEN](                  
 @Email varchar(100)                  
)                  
as                  
 declare @rolId int            
  ...
  IF(@rolId = 4)                  
   ...
   IF(@rolId = 52)                  
    begin                  
      ...
      where LOWER(su.EmailEmpresa) = @Email and sr.RolId = 52              
      -- and                  
      -- su.Nombres is not null;                    
   END      
