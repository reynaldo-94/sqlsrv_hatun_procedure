...
' Cambios:                     
  ...
  21/11/2022 - cristian silva - se valido RolID = 11 (callCenter) y se creo el '@advIdcall' que me trae el ADO aleatorio con respecto al local higereta    
  19/12/2022 - Reynaldo Cauche - Se cambio el valor de tipoTrabajo, ahora obtiene el tipoTrabajoId correcto    
'--------------------------------------------------------------------------------------*/                                                                                       
                                                                                   
CREATE PROCEDURE SGC_SP_ExpedienteCredito_Gestion_erivar                                                 
