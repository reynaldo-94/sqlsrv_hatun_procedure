...
' Cambios:                                    
  ...
  17/01/2023 - Reynaldo Cauche - Agrege condicion rolid = 56 al lado de rol 11             
'--------------------------------------------------------------------------------------*/                                                                                                      
                                                                                                  
CREATE PROCEDURE SGC_SP_ExpedienteCredito_Gestion_Derivar_U               
...
BEGIN TRY                                                       
    BEGIN TRANSACTION                                                                    
        ...
        IF (@advIdZonal > 0 and @RolId = 2)--zonal            
            BEGIN              
                if(@advIdrol = 0)              
                    BEGIN              
                        UPDATE SGF_ExpedienteCredito                                                                  
                ...
                if(@advIdrol > 0)                
                    ...
                    END              
                END               
        ELSE if((@advIdZonal is null or @advIdZonal =0) and @RolId = 2)                    
            BEGIN                                                                 
                SET @Success = 2;                 
                SET @Message = 'No se puede enviar a Gestión, por que no hay ADV Registrado';                                                                    
            END           
